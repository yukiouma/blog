...
最近在学习使用IDEA进行大数据的离线开发，摘取了极客学院的[IDEA使用教程--IDEA快捷键](http://wiki.jikexueyuan.com/project/intellij-idea-tutorial/keymap-introduce.html)中的部分内容留作自己平时查阅用，有兴趣了解全文的同学请移步极客学院的IDEA教程
